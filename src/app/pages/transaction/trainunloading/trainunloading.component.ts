...
@Component({
  ...
  templateUrl: './trainunloading.component.html',
  styleUrls: ['./trainunloading.component.scss']
})
export class PageTrainUnloadingComponent implements OnInit {
  pageTitle: string = 'Train Unloading';
  awbno: String;
  bookdate: String;
  company: String;
  consignor: String;
