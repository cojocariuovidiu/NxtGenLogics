 ...
 /* {
  ...
  },*/
  {
    ...
    sub: [
      ...
      {
        title: 'Train Master',
        routing: '/default-layout/train-master'
      },
      {
        title: 'Hub Master',
        routing: '/default-layout/hub-master'
      },
      {
        title: 'Staffing',
  ...
  },
  {
    ...
    sub: [
      ...
      {
        title: 'Register',
        routing: '/default-layout/register'
      },
      {
        title: 'Bundles',
        routing: '/default-layout/addbundle'
      },
      {
        title: 'Hub In',
        routing: '/default-layout/hubin'
      },
      {
        title: 'Hub Out',
        routing: '/default-layout/hubout'
      },
      {
        title: 'Train Loading',
        routing: '/default-layout/trainloading'
      },
      {
        title: 'Train Unloading',
        routing: '/default-layout/trainunloading'
      },
      {
      ...
      {
        title: 'Awb Tracking',
        routing: '/default-layout/awbtracking'
      },
    ],
    routing: '',
    externalLink: '',
  ...
  },
  {
    ...
    sub: [
      ...
      {
        title: 'Incoming Courier wise',
        routing: '/default-layout/simple-table'
      },
      {
        title: 'Outgoing Courier Wise',
        routing: '/default-layout/simple-table'
      },
      {
        title: 'Incoming Destination wise',
        routing: '/default-layout/simple-table'
      },
      {
        title: 'Outgoing Destination Wise',
        routing: '/default-layout/simple-table'
      },
      {
