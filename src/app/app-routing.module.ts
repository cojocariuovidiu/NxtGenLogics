...
import { PageTrainLoadingComponent }    from './pages/transaction/trainloading/trainloading.component';
import { PageTrainUnloadingComponent }  from './pages/transaction/trainunloading/trainunloading.component';
import { PageHubInComponent }           from './pages/transaction/hubin/hubin.component';
import { PageHubOutComponent }          from './pages/transaction/hubout/hubout.component';
...
const defaultRoutes: Routes = [
  ...
  { path: 'trainloading', component: PageTrainLoadingComponent },
  { path: 'trainunloading', component: PageTrainUnloadingComponent },
  { path: 'hubin', component: PageHubInComponent },
  { path: 'hubout', component: PageHubOutComponent },
